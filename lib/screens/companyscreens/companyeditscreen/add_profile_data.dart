...
class AddProfielScreen extends StatefulWidget {
  const AddProfielScreen({Key? key}) : super(key: key);

  @override
  State<AddProfielScreen> createState() => _AddProfielScreenState();
}

class _AddProfielScreenState extends State<AddProfielScreen> {
  @override
